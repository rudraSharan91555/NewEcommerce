...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <hr />
            <div class="col">
                <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="saveData('0','','')"
                    class="btn btn-outline-info px-5 radius-30">Add ADD category attribute</button>
            </div>
            <hr/>
            <div class="card">
                <div class="card-body">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formSubmit" action="{{ url('admin/update_category_attribute') }}" method="post"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="attribute_id" id="attribute_id">
                                        <option value="0">Select Attribure Id</option>
                                        @foreach ($attribute as $list2)
                                            <option value="{{ $list2->id }}">{{ $list2->name }}({{ $list2->slug }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
