...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">ADD Color</h6>
        <hr />
        <div class="col">
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" onclick="saveData('{{$list->id}}','{{$list->text}}','{{$list->value}}')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Update</button>
            ...
            <form id="formSubmit" action="{{url('admin/updatecolor')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="border p-4 rounded">
                        ...
                        <div class="row mb-3">
                            <label for="enter_text" class="col-sm-3 col-form-label">Hex Code </label>
                            <div class="col-sm-9">
