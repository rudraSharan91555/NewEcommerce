...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <hr />
            <div class="col">
                <a href="{{ url('admin/manage_product') }}/0"> <button type="button"
                        class="btn btn-outline-info px-5 radius-30">Add ADD Product</button></a>
            </div>
            <hr/>
            <div class="card">
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($data as $list)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('admin/manage_product') }}/{{ $list->id }}"><button
                                                    type="button" class="btn btn-outline-info px-5 radius-30"
