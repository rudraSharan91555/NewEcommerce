        ...
        <div class="page-content">
            ...
            <div class="col">
                <button type="button" onclick="saveData('0','')" class="btn btn-outline-info px-5 radius-30"
                    data-bs-toggle="modal" data-bs-target="#exampleModal">Add Tax</button>
                <hr />
            </div>
            <div class="card">
                <div class="card-body">
                                ...
                                @foreach ($data as $list)
                                    <tr>
                                        ...
                                        <td><button type="button"
                                            ...
                                            <button onclick="deleteData('{{ $list->id }}','taxes')"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formSubmit" action="{{ url('admin/updateTax') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="text" class="form-control" id="enter_text"
