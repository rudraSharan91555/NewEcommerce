                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="third-slider-img">
                                            ...
                                            <img :src="item.image" alt="Image" class="main-img"
                                                style="height:537px; width: 560px;"
                    ...
                    <div class="row no-gutters trending-product-grid">
                        <div class="col-2">
                            <div class="trending-products-list">
                                ...
                                <ul class="nav nav-tabs" id="trendingTab" role="tablist">
                                    ...
                                    <li v-for="(catItem, index) in getShortArray(6)" :key="catItem.id" class="nav-item"
                                        role="presentation">
                        ...
                        <div class="col-10">
                            <div class="tab-content tp-tab-content " id="trendingTabContent">
                                ...
                                <div v-for="(catItem, index) in getShortArray(9)" :key="catItem.id"
                                    :class="'tab-pane' + showActiveClass(2, index)" :id="'cat' + catItem.id" role="tabpanel"
                                    :aria-labelledby="'cat-tab' + catItem.id">
                                        ...
                                        <div v-for="item in catItem.products" class="col">
                                            <div class="features-product-item">
                                                ...
                                                <div class="features-product-content">
                                                    ...
                                                    <p class="price">INR {{ item.product_attributes[0].price }}</p>
                                                ...
                                                <div class="features-product-cart"><a href="cart.html">add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="new-arrival-nav mb-35">
                                <button v-for="(catItem, index) in getShortArray(9)" class="active" :key="catItem.id"
                                    :class="'' + showActiveClass(1, index)" :data-filter="'.cart-' + catItem.id">{{
                                    catItem.name }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="row new-arrival-active">
                        <div v-for="item in homeProducts"
                            :class="'col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-' + item.categories">
