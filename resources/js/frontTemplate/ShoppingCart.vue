                                            ...
                                            <tbody>
                                                <tr v-for="item in slotProps.cartProduct" :key="item.id">
                                                    <td class="product-thumbnail"><a href="shop-details.html"><img
                                                                :src="item.products[0].image" alt=""></a></td>
                                                    <td class="product-name">
                                                        <h4><router-link
                                                                :to="'/product/' + item.products[0].item_code + '/' + item.products[0].slug">{{
                                                                item.products[0].name }}</router-link>]</h4>
                                                    </td>
                                                    <td class="product-price">Rs {{
                                                        item.products[0].product_attributes[0].price }}</td>
                                                        ...
                                                        <div class="cart-plus-minus">
                                                            <form action="#" class="num-block">
                                                                ...
                                                                <div class="qtybutton-box">
                                                                    <span class="plus"
                                                                        v-on:click="slotProps.addToCart(item.products[0].id, item.products[0].product_attributes[0].id, item.qty + 1)"><img
                                                                            src="front_assets/img/icon/plus.png"
                                                                            alt=""></span>
                                                                    <span class="minus dis"
                                                                        v-on:click="slotProps.addToCart(item.products[0].id, item.products[0].product_attributes[0].id, item.qty - 1)"><img
                                                                            src="front_assets/img/icon/minus.png"
                                                                            alt=""></span>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </td>
                                                    <td class="product-subtotal"><span>Rs {{
                                                            item.products[0].product_attributes[0].price * item.qty
                                                            }}</span></td>
                                                    <td class="product-delete"><a href="javascript:void(0)"
                                                            @click="slotProps.removeCartData(item.products[0].id, item.products[0].product_attributes[0].id, item.qty)"><i
                                        ...
                                        <form action="#">
                                            <ul>
                                                ...
                                                <li class="cart-total-amount"><span>TOTAL</span> <span
                                                        class="amount">Rs{{ slotProps.cartTotal }}</span></li>
                                            </ul>
